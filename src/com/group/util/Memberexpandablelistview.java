...
public class Memberexpandablelistview extends ExpandableListView implements OnScrollListener{
	...
	private OnExpandablelistviewRefreshListener refreshListener;

	public Memberexpandablelistview(Context context) {
		super(context);
		init(context);
	...
	public Memberexpandablelistview(Context context, AttributeSet attrs, int defStyle) {
	...
	public Memberexpandablelistview(Context context, AttributeSet attrs) {
		super(context, attrs);		
		init(context);
		// TODO Auto-generated constructor stub
	}
		...
		if(isrefreshable){
			...
			case MotionEvent.ACTION_MOVE:
				...
				if(state!=Refreshing && isrecored && state!=Loading){
					if(state==release_to_refresh){
						setSelection(0);       //当setselection为0时 滑动的手指不会点中item    类似于设置光标位置
	...
	public interface OnExpandablelistviewRefreshListener{
		public void onRefresh();
	}
	
	public void setOnRefreshListener(OnExpandablelistviewRefreshListener refreshListener){
